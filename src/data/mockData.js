...
export const departments = [
  { id: 1, name: "Производство", head: "Алексей Воронов", employeeCount: 42, kpi: 81, color: "#6366f1" },
  { id: 2, name: "IT", head: "Дмитрий Козлов", employeeCount: 15, kpi: 92, color: "#22c55e" },
  { id: 3, name: "HR", head: "Марина Соколова", employeeCount: 8, kpi: 87, color: "#f59e0b" },
  { id: 4, name: "Бухгалтерия", head: "Елена Новикова", employeeCount: 6, kpi: 79, color: "#ec4899" },
  { id: 5, name: "Маркетинг", head: "Анна Петрова", employeeCount: 11, kpi: 88, color: "#14b8a6" },
  { id: 6, name: "Логистика", head: "Павел Орлов", employeeCount: 19, kpi: 75, color: "#f97316" },
];
...
export const tasks = [
  ...
  { id: 2, title: "Провести аудит ИТ-инфраструктуры", assignee: "Дмитрий Козлов", department: "IT", deadline: "2026-03-25", status: "pending", kpiWeight: 15, priority: "medium" },
...
export const surveys = [
  ...
  { id: 4, title: "Аттестация знаний ИТ-специалистов", type: "test", status: "draft", responses: 0, total: 15, deadline: "2026-04-15", createdBy: "Дмитрий Козлов", description: "Проверка технических компетенций IT-отдела" },
...
export const appeals = [
  ...
  { id: 3, subject: "Конфликт с непосредственным руководителем", from: "Аноним", department: "Логистика", date: "2026-03-01", status: "resolved", priority: "high", category: "Рабочие отношения", description: "Описание ситуации конфликта..." },
